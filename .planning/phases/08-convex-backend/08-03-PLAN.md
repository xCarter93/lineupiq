...
files_modified:
  ...
  - packages/frontend/src/hooks/usePredictions.ts
...
<task type="auto">
  ...
  <verify>
    - `npx convex dev` shows functions deployed
...
<task type="auto">
  ...
  <files>packages/frontend/src/hooks/usePredictions.ts, packages/frontend/src/hooks/usePlayers.ts</files>
  <action>
    1. Create src/hooks/usePredictions.ts:
    ...
    2. Create src/hooks/usePlayers.ts:
...
- [ ] `npx convex dev` shows all prediction and player functions deployed
