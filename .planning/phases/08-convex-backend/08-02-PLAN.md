...
files_modified:
  ...
  - packages/frontend/src/hooks/useScoringConfigs.ts
autonomous: true
---
...
<task type="auto">
  ...
  <verify>
    - `npx convex dev` shows functions deployed without errors
...
<task type="auto">
  ...
  <files>packages/frontend/src/hooks/useScoringConfigs.ts</files>
  <action>
    Create src/hooks/useScoringConfigs.ts with custom hooks:
...
<task type="auto">
  ...
  <files>packages/frontend/src/components/providers/ConvexClientProvider.tsx</files>
  <action>
...
- [ ] `npx convex dev` shows all functions deployed
